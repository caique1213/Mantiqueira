-- Fix ambiguous output-column references in inventory listing RPC.
...
begin
  ...
  filtered as (
    ...
    where
      safe_completeness = 'all'
      or (safe_completeness = 'complete' and s.completeness_percent >= 100)
      or (safe_completeness = 'incomplete' and s.completeness_percent < 100)
      or (safe_completeness = 'missing_nameplate' and s.has_nameplate_photo = false)
  ),
  counted as (
