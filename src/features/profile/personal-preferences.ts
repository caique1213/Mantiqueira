...
const LIGHT_PATCH: Record<string, string> = {
  ...
  '--color-button-primary': '#E5AA00',
  '--color-button-primary-text': '#221900',
  '--color-button-primary-hover': '#C99500',
  '--color-button-secondary': '#EFE4C6',
  '--color-button-secondary-text': '#1F1A12',
  '--color-button-secondary-hover': '#E2D5B1',
  '--color-button-danger': '#C4323A',
  '--color-button-danger-text': '#FFFFFF',
  '--color-button-danger-hover': '#A3272E',
  '--map-empty': '#E7D9B6',
  '--map-posture': '#FFF9EA',
};
...
const DARK_PATCH: Record<string, string> = {
  ...
  '--color-button-primary': '#F6B900',
  '--color-button-primary-text': '#171104',
  '--color-button-primary-hover': '#FFD248',
  '--color-button-secondary': '#252C35',
  '--color-button-secondary-text': '#F5F7FA',
  '--color-button-secondary-hover': '#343D49',
  '--color-button-danger': '#C93D42',
  '--color-button-danger-text': '#FFFFFF',
  '--color-button-danger-hover': '#E5484D',
  '--map-empty': '#11151A',
  '--map-posture': '#252C35',
};
